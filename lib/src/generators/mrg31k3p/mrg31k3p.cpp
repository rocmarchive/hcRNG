...
hcrngStatus hcrngMrg31k3pSetAcclView(hcrngMrg31k3pStreamCreator* creator, hc::accelerator_view accl_view, void* stream) {
  creator->currentAcclView = &accl_view;
  creator->currentStream = stream;
  return HCRNG_SUCCESS;
}

hcrngStatus hcrngMrg31k3pGetAcclView(hcrngMrg31k3pStreamCreator* creator, hc::accelerator_view *&accl_view, void** stream) {
  if (creator == nullptr) {
...
hcrngStatus hcrngMrg31k3pDeviceRandomU01Array_single(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
...
hcrngStatus hcrngMrg31k3pDeviceRandomNArray_single(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
...
#define HCRNG_SINGLE_PRECISION
	...
	if (numberCount < 1)
		return HCRNG_INVALID_VALUE;
        hcrngStatus status = hcrngMrg31k3pDeviceRandomU01Array_single(accl_view, streamCount, streams,numberCount, outBuffer, streamlength, streams_per_thread);
...
hcrngStatus hcrngMrg31k3pDeviceRandomU01Array_double(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
...
hcrngStatus hcrngMrg31k3pDeviceRandomNArray_double(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
	size_t numberCount, double mu, double sigma, double *outBuffer, int streamlength, size_t streams_per_thread)
{
	...
	if (numberCount < 1)
		return HCRNG_INVALID_VALUE;
        hcrngStatus status = hcrngMrg31k3pDeviceRandomU01Array_double(accl_view, streamCount, streams,numberCount, outBuffer, streamlength, streams_per_thread);
        if (status == HCRNG_SUCCESS){
...
hcrngStatus hcrngMrg31k3pDeviceRandomIntegerArray_single(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
        size_t numberCount, int a, int b, int *outBuffer, int streamlength, size_t streams_per_thread)
{
        ...
        hc::parallel_for_each(accl_view, t_ext, [ = ] (hc::tiled_index<1> tidx) [[hc, cpu]] {
           ...
           for(int i =0; i < (numberCount-1)/streamCount+1; i++) {
              for (int j = 0; j < streams_per_thread; j++)
               if ((streams_per_thread * (i * (streamCount/streams_per_thread) + gid) + j) < numberCount)
                outBuffer[streams_per_thread * (i * (streamCount/streams_per_thread) + gid) + j] = hcrngMrg31k3pRandomInteger(&streams[streams_per_thread * gid + j], a, b);
              }
           }
        }).wait();
        return status;
...
hcrngStatus hcrngMrg31k3pDeviceRandomIntegerArray_double(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
        size_t numberCount, int a, int b, int *outBuffer, int streamlength, size_t streams_per_thread)
{
        if (streamCount < 1)
                return HCRNG_INVALID_VALUE;
...
hcrngStatus hcrngMrg31k3pDeviceRandomUnsignedIntegerArray_single(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
        size_t numberCount, unsigned int a, unsigned int b, unsigned int *outBuffer, int streamlength, size_t streams_per_thread)
{
        ...
        hc::parallel_for_each(accl_view, t_ext, [ = ] (hc::tiled_index<1> tidx) [[hc, cpu]] {
           ...
           for(int i =0; i < (numberCount-1)/streamCount+1; i++) {
              for (int j = 0; j < streams_per_thread; j++)
               if ((streams_per_thread * (i * (streamCount/streams_per_thread) + gid) + j) < numberCount)
                outBuffer[streams_per_thread * (i * (streamCount/streams_per_thread) + gid) + j] = hcrngMrg31k3pRandomUnsignedInteger(&streams[streams_per_thread * gid + j], a, b);
              }
           }
        }).wait();
        return status;
...
hcrngStatus hcrngMrg31k3pDeviceRandomUnsignedIntegerArray_double(hc::accelerator_view accl_view, size_t streamCount, hcrngMrg31k3pStream *streams,
        size_t numberCount, unsigned int a, unsigned int b, unsigned int *outBuffer, int streamlength, size_t streams_per_thread)
{
        if (streamCount < 1)
                return HCRNG_INVALID_VALUE;
