...
TEST(hiprng_uniform, hip_mrg32k3aDouble_uniform ) {
  ...
  hiprngCreateGenerator(&gen, HIPRNG_RNG_PSEUDO_MRG32K3A);
  //  Set seed
  hiprngSetPseudoRandomGeneratorSeed(gen,0);
  // Generate random numbers
  hiprngStatus_t status = hiprngGenerateUniformDouble(gen, devData1, n);
