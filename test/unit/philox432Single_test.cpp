...
void multistream_fill_array(size_t spwi, size_t gsize, size_t quota, int substream_length, hcrngPhilox432Stream* streams, float* out_)
{
...
TEST(philox432Single_test, Functional_check_philox432Single)
{
